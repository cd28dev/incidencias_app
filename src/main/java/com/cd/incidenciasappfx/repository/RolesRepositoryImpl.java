...
public class RolesRepositoryImpl implements IRolesRepository {
    ...
    public Optional<Rol> save(Rol rol) {
        try {
            StoredProcedureQuery query = entityManager.createStoredProcedureQuery("sp_insertar_rol");
    ...
    public boolean delete(int idRol) {
        try {
            StoredProcedureQuery query = entityManager.createStoredProcedureQuery("sp_eliminar_rol");
